...
def process(method):
    ...
    print(f'[INFO] there are {empty_num} molcules have no substructure')
    ...
    for split in ['assay', 'scaffold', 'size']:
        ...
        with open(f'lbap_core_ec50_{split}.json') as f:
            INFO = json.load(f)
        ...
        with open(f'lbap_core_ec50_{split}_{method}.json', 'w') as f:
